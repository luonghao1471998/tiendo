...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('layers', function (Blueprint $table) {
            ...
            $table->foreignId('master_layer_id')->constrained('master_layers')->cascadeOnDelete()->notNullable();
            ...
            $table->integer('next_zone_seq')->notNullable()->default(0); // PATCH-15
            ...
            $table->foreignId('uploaded_by')->constrained('users')->cascadeOnDelete()->notNullable();
